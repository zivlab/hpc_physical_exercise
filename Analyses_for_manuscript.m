...
legend('Control','Run','FontName', 'Arial','FontSize', 40,'Location','northwest','box','off');
axis square
xticks([1 2 3 4 5 6 7 8]);
xticklabels({'1','4','7','10','13','16','19','22'});
ylim([0.02 0.036])
...
set(gca,'linewidth',4)
for i=1:5
plot([1:8],stuck_fraction_of_PCs,...
    '-','LineWidth',5,...
    'MarkerSize',6,...
    'MarkerEdgeColor','b',...
    'MarkerFaceColor','b',...
    'Color','b');
plot([1:8],funct_fraction_of_PCs,...
    '-','LineWidth',5,...
    'MarkerSize',6,...
    'MarkerEdgeColor','r',...
    'MarkerFaceColor','r',...
...
set(gca,'linewidth',4)
for i=1:5
plot([1:8],stuck_num_of_active_cells,...
    '-','LineWidth',5,...
    'MarkerSize',6,...
    'MarkerEdgeColor','b',...
    'MarkerFaceColor','b',...
    'Color','b');
plot([1:8],funct_num_of_active_cells,...
    '-','LineWidth',5,...
    'MarkerSize',6,...
    'MarkerEdgeColor','r',...
    'MarkerFaceColor','r',...
...
xlabel('Time (days)','FontName', 'Arial', 'FontSize', 48);
ylabel({'Active cells (#)'},'FontName', 'Arial', 'FontSize', 48);
legend('Control','Run','FontName', 'Arial','FontSize', 40,'Location','northeast','box','off');
axis square
xticks([1 2 3 4 5 6 7 8]);
xticklabels({'1','4','7','10','13','16','19','22'});
ylim([350 700])
...
legend('Control same env','Run same env','Control diff env','Run diff env','FontName', 'Arial','FontSize', 28,'Location','northwest','box','off');
% ylim([0.2 1])
ylim([0 1])
axis square
...
xticklabels({'3','6','9','12','15','18','21'});
ylabel({'Ensemble activity';'correlation'},'FontName', 'Arial', 'FontSize', 48);
legend('Control same env','Run same env','Control diff env','Run diff env','FontName', 'Arial','FontSize', 28,'Location','northeast','box','off');
axis square
ylim([0 0.7])
